...
int Search(struct Club *, int, struct Club **, int *);
int SearchByExact(struct Club *, int, struct Club **, int *, int);
int SearchByRange(struct Club *, int, struct Club **, int *, int);
int SearchByMore(struct Club *, int, struct Club **, int *, int);
int SearchByLess(struct Club *, int, struct Club **, int *, int);
