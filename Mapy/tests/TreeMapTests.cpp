...
template <typename K>
void thenMapIsBalanced(const Map<K>& map)
{
  auto result = true;
  for(auto it = map.begin(); it != map.end(); it++)
  {
    //it.getCurrentNode()->printNode(std::cout);
    if(it.getCurrentNode()->isUnbalanced())
    {
      result = false;
      break;
    }
  ...
  BOOST_REQUIRE_MESSAGE(result, "Tree is unbalanced");
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenMap_WhenAddingItems_ThenMapIsBalanced,
                              K,
                              TestedKeyTypes)
{
  Map<K> map;
  map[100] = "";
  thenMapIsBalanced(map);
  map[50] = "";
  thenMapIsBalanced(map);
  map[150] = "";
  thenMapIsBalanced(map);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyMap_WhenRemovingItems_ThenMapIsBalanced,
                              K,
                              TestedKeyTypes)
{
  Map<K> map;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenMap_WhenLeftRotatingAfterAdding_ThenMapIsBalanced,
                              K,
                              TestedKeyTypes)
{
  Map<K> map = {{100, ""}, {50, ""}, {150, ""}};
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenMap_WhenRightRotatingAfterAdding_ThenMapIsBalanced,
                              K,
                              TestedKeyTypes)
{
  Map<K> map = {{100, ""}, {50, ""}, {150, ""}};
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenMap_WhenLeftRightRotatingAfterAdding_ThenMapIsBalanced,
                              K,
                              TestedKeyTypes)
{
  Map<K> map = {{100, ""}, {50, ""}, {150, ""}};
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenMap_WhenRightLeftRotatingAfterAdding_ThenMapIsBalanced,
                              K,
                              TestedKeyTypes)
{
  Map<K> map = {{100, ""}, {50, ""}, {150, ""}};
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenMap_WhenLeftRotatingAfterRemoving_ThenMapIsBalanced,
                              K,
                              TestedKeyTypes)
{
  Map<K> map = {{100, ""}, {50, ""}, {150, ""}, {200, ""}};
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenMap_WhenRightRotatingAfterRemoving_ThenMapIsBalanced,
                              K,
                              TestedKeyTypes)
{
  Map<K> map = {{100, ""}, {50, ""}, {150, ""}, {0, ""}};
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenMap_WhenLeftRightRotatingAfterRemoving_ThenMapIsBalanced,
                              K,
                              TestedKeyTypes)
{
  Map<K> map = {{100, ""}, {50, ""}, {150, ""}, {75, ""}};
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenMap_WhenRightLeftRotatingAfterRemoving_ThenMapIsBalanced,
                              K,
                              TestedKeyTypes)
{
  Map<K> map = {{100, ""}, {50, ""}, {150, ""}, {125, ""}};
