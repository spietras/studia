...
def train(dataset_path: Path = typer.Argument(..., file_okay=False, readable=True,
          ...
          d_model: int = typer.Option(64, "--d-model", "-dm", help="The size of the vector representing one token."),
          d_ff: int = typer.Option(16, "--d-ff", "-df", help="The size of the first layer in the FFN in each layer "
