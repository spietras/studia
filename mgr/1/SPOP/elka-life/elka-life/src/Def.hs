...
questLab2 = do putStrLn "Witaj, dzielny adepcie Technik Sygnałów i Informacji!"
               ...
               score <- case input of
                    ...
                    _ -> do putStrLn "Możliwe opcje do wyboru: PISZĘ PRACĘ DOMOWĄ, UWAŻAM"
                            questLab2
               return score
...
questLab3 hw = do if hw == True
                    then do putStrLn "Prowadzący spostrzegł, że zajmujesz się czymś zdecydowanie mniej ciekawym niż prowadzone przez niego ćwiczenia, ale uszło Ci to płazem."
                            ...
                            score <- questLab4 hw
                            return score
                    else do putStrLn "Zieeew..."
                            score <- questLab4 hw
                            return score

questLab4 :: Bool -> IO Int
questLab4 hw = do putStrLn "No dobrze, ćwiczenia się skończyły, laboratorium już za godzinę, a Tobie burczy w brzuchu..."
                  ...
                  score <- case input of
                        ...
                        _ -> do putStrLn "Możliwe opcje do wyboru: IDĘ JEŚĆ, UCZĘ SIĘ"
                                questLab4 hw
                  return score
...
questLab5_1 hw = do putStrLn "Myślisz sobie - dość tego ruskiego! Idę na spaghetti alla carbonara!"
                    ...
                    score <- case input of
                            ...
                            _ -> do putStrLn "Możliwe opcje do wyboru: IDĘ SPAĆ, IDĘ NA LABORATORIUM"
                                    questLab5_1 hw
                    return score

questLab5_2 :: IO Int
questLab5_2 = do putStrLn "Ty pracusiu! Wiele się nie nauczyłeś, ale zawsze lepsze to niż nic."
                 ...
                 score <- case input of
                        ...
                        _ -> do putStrLn "Możliwe opcje do wyboru: TAK, NIE"
                                questLab5_2
                 return score


questLab6_1 :: IO ()
questLab6_1 = do putStrLn "Wiadomo, opuszczenie jednego laboratorium to nie koniec świata, a mała sjesta po wyżerce zawsze się przyda..."
...
questLab6_2 cheats food = do putStrLn "Docierasz na labkę. Wyjeżdżasz windą na piętro dwie minutki przed, wychodzisz, a tam masa ludzi tli się przy drzwiach wejściowych..."
                             ...
                             score <- case input of
                                 ...
                                 _ -> do putStrLn "Możliwe opcje do wyboru: IDĘ, ZOSTAJĘ"
                                         questLab6_2 cheats food
                             return score

questLab7 :: Bool -> Bool -> Bool -> IO Int
questLab7 cheats food door = do putStrLn "Drzwi się otwierają, i przypominasz sobie znajomą twarz - ostatnio ten prowadzący dał Ci popalić na labce..."
...
questLab8_2 cheats food = do    putStrLn "Niestety, trafiłeś do swojego starego, (ekhm) dobrego znajomego. Wejściówka oczywiście zbiła Cię z tropu."
