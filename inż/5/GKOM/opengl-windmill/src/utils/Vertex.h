...
public:
    ...
    const glm::vec2 &getTexture() const { return texture; }
    ...
    static unsigned int getTextureDim() { return 2; }
    static unsigned int getTextureSize() { return sizeof(glm::vec2); }
    static long getTextureOffset() { return getNormalOffset() + getNormalSize(); }
};
