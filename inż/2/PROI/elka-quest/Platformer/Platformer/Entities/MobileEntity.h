...
public:
	...
	MobileEntity() : velocity_(0.0f, 0.0f), speed_(0.0f, 0.0f), gravity_(0.0f), friction_(0.0f), onGround(false) { }

	MobileEntity(sf::Texture& texture, sf::Vector2f position, sf::Vector2f speed, float gravity, float friction) :
